<form action="{{ route('stocks') }}" method="get" name="stockForm">
    <h2>Склады</h2>
    <input type="text" name="dateFrom" id="dateFrom" value="2024-12-07">
    <button type="submit">Получить</button>
</form>

<form action="{{ route('incomes') }}" method="get" name="incomeForm">
    <h2>Доходы</h2>
    <input type="text" name="dateFrom" id="dateFrom" value="2024-12-01">
    <input type="text" name="dateTo" id="dateTo" value="2024-12-07">
    <button type="submit">Получить</button>
</form>
